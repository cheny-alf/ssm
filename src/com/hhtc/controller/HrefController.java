...
public class HrefController {
	 ...
	 * @return
	 */
	@RequestMapping("/hrefstudetail")
	public String detailstu(String id,Model model) {
		Student student=adminService.selectone(id);
		model.addAttribute("student",student);
		return "admin/studetail";
	}
	@RequestMapping("/hrefxiustufenshu")
	public String xiustufenshu(String id,Model model) {
		Student student=adminService.selectone(id);
		model.addAttribute("student",student);
		return "teacher/teaUpdatestu";
	}
	/**
	 * 学生管理
	 * @param model
