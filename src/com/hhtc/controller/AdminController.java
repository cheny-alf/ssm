...
public class AdminController {
	...
	//学生
		...
		public ModelAndView detailstu(String id,Student student,Model model) {
			student.setId(Integer.parseInt(id));
			Student student2 = adminService.selectone(id);
			ModelAndView mav = new ModelAndView("admin/stumanage");
			return mav;
		}
		@RequestMapping("/teaUpdatestu")
		public ModelAndView teaUpdatestu(String id,Student student,Model model) {
			student.setId(Integer.parseInt(id));
			adminService.teaupdatestu(student);
			ModelAndView mav = new ModelAndView("teacher/addscore");
			return mav;
		}
		@RequestMapping(value = "/mohuname",method = {RequestMethod.POST, RequestMethod.GET},
	...
	//老师
		...
		//修改管理员密码
		@RequestMapping("/hrefUpdateAdminPw")
		public ModelAndView hrefupdateAdminPw(Model model) {
			ModelAndView mav = new ModelAndView("admin/updateAdminPws");
			return mav;
		}
		@RequestMapping("/updateAdminPw")
		public ModelAndView updatepw(Admin admin,Model model) {
			this.generaService.updateAdminPw(admin);
